...
namespace service_task
{
	...
	boost::shared_ptr<ServiceTaskI> pInstance;


	boost::shared_ptr< ServiceTask > ServiceTask::Build_Service()
	{
		if (!pInstance)
		{
			// Creamos una nueva instancia
			pInstance.reset(new ServiceTaskI());
		}
		// Devolvemos un puntero a la instancia
		return pInstance;
	}
	...
	ServiceTaskI::ServiceTaskI() : work_io_service_(), // Construct the IO Service
